...
def unpack_iso():
    ...
    if iso_name == None:
        ...
        quit()
    if not os.path.exists("Shining_Ark_PATCHED.iso"):
        shutil.copy(iso_name,"Shining_Ark_PATCHED.iso")
...
def insert_iso():
    print("Iso file...")
    os.system(r"bin\Umd-replace\UMD-replace.exe Shining_Ark_PATCHED.iso PSP_GAME\INSDIR\DATA.BIN isofiles\DATA.cpk.encrypt")
    os.system(r"bin\Umd-replace\UMD-replace.exe Shining_Ark_PATCHED.iso PSP_GAME\SYSDIR\EBOOT.BIN isofiles\EBOOT_PATCHED.BIN")
    os.system(r"bin\Umd-replace\UMD-replace.exe Shining_Ark_PATCHED.iso PSP_GAME\ICON0.PNG  isofiles\ICON0_PATCHED.PNG")
