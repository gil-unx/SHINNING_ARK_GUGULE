...
namespace Sb
{
    ...
    public class MXE
    {
        ...
        public MXE(string mxeName)
        {
            ...
            Console.WriteLine("{0,0:X8},", reader.BaseStream.Position);
            xxxxxxxxx = (int)reader.BaseStream.Position;
        ...
        public void WriteTxt(string txtName)
        {
            ...
            foreach (string text in listText)
            {
                ...
                foreach (var item in offsets[i])
                {
                    writer.Write(string.Format("{0,0:X8},", (item * 4) + xxxxxxxxx));
                }
                writer.Write("\n");
            ...
            foreach (var xx in offsets)
            {
                foreach (var item in xx)
                {
                    writer.Write(string.Format("{0,0:X8}\n", (item * 4) + xxxxxxxxx));
                }
            }
